...
import { controllerAddProduct, controllerGetActiveCart, controllerGetBuyedCarts, controllerGetCartWithProducts, controllerRemoveProductOfTheCart } from "../controllers/cartController";

const cartRouter = Router();

cartRouter.use(apiKeyMiddleware);

cartRouter.get('/buyed/cart/:idUsuario', controllerGetBuyedCarts); // todos os carrinhos ja comprados
